...
export class TrainingCourseHeldBatchListComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.dataStorageService.fetchTrainingCourseHeldBatchList({ UniqueName: 'TrainingCoursesCompanyCategory' }).subscribe(() => {
